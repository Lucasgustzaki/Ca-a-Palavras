...
public class CacaPalavras {
    ...
    private CacaPalavras() {
        ...
        do {
            System.out.print("_ Menu: Caça Palavras _" +
                    "\n1. listar palavras" +
                    "\n2. listar mapa" +
                    "\n3. listar respostas" +
                    "\n4. sair" +
                ...
                for (int j = 0; j < 5; j++) {
                    if (palavras[linhaMatrizPalavra][0].charAt(0) == mapa[i][j]) {
                        ...
                        if (palavras[linhaMatrizPalavra][0].length() <= (mapa[0].length - j)) {
                            // analisaEsquerdaDireita(palavras, mapa, i, j);
    ...
    public boolean analisaEsquerdaDireita(String[][] palavras, char[][] mapa, int i, int j) {
